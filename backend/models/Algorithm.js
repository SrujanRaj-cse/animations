    ...
    parameters: [
      {
        ...
        type: {
          type: String,
          enum: ['number', 'array', 'string', 'boolean'],
          required: true,
        },
...
// NOTE: Single field index on 'category: 1' has been removed because
// it was redundant and likely causing the "algorithmCategory" warning.
